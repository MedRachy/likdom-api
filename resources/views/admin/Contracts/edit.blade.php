...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Modifier contrat</div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="subscription_id" type="text"
                                    ...
                                    name="subscription_id" value="{{ $contract->subscription_id }}"
