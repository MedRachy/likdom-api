    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.offer.update', $offer->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="label" type="text"
                                    ...
                                    value="{{ $offer->label }}" autocomplete="label" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text"
                                    ...
                                    value="{{ $offer->name }}" autocomplete="name">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="description" type="text"
                                    ...
                                    value="{{ $offer->description }}" autocomplete="description">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select  @error('user_type') is-invalid @enderror" id="selectuser_type"
                                    name="user_type">
                                    <option value="pro" {{ $offer->user_type === 'pro' ? 'selected' : '' }}>Pro</option>
                                    <option value="part" {{ $offer->user_type === 'part' ? 'selected' : '' }}>Part
                                    </option>
                                </select>
                            </div>
